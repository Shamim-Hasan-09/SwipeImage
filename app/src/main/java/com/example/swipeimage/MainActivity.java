...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayList<Integer> images = new ArrayList(Arrays.asList(R.drawable.sh,
                R.drawable.sha, R.drawable.sham,
                R.drawable.shamim,R.drawable.kermit_opening_bottle,R.drawable.nat,R.drawable.natt));
